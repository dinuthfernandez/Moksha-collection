...
// Single source of truth for country names and calling codes, used both for
// picking a delivery-address country (name) and a phone country code (dialCode).
export const COUNTRIES: Country[] = [
  ...
  { name: 'Congo (DR)', code: 'CD', dialCode: '+243' },
